    ...
    <div class="blog-container">
        ...
        <BlogContent :useCatalog="false">
            <div slot="content">
                ...
                <img src="~@/assets/blog/bg-20180813-01.jpg">

                <p>
                    2005年，亚马逊推出
                    <a href="https://www.mturk.com/" target="_blank">Mechanical Turk</a>
                    ，允许世界各地的人们到该网站接单，完成任务后领取报酬。这就是第一种 API 之下的工作，此后这类工作不断增加，直到今天。
                </p>
