        ...
        <BlogContent :useCatalog="false">
            <div slot="content">
                <blockquote>
                    <p>
                        这篇文章摘自阮一峰网络日志中的
                        <a href="http://www.ruanyifeng.com/blog/2018/10/weekly-issue-27.html" target="_blank">
                            每周分享第 27 期
                        </a>
                        ，有一本书反对了当年乔布斯的演讲中提出的观念，认为“热情假设”不是一个好的建议。
                    </p>
                </blockquote>

                <img src="~@/assets/blog/bg-20181019-01.jpg">
                ...
                <img src="~@/assets/blog/bg-20181019-02.jpg">

                <p>
                    但是，美国最近出版了一本新书《优秀到无法忽略》（《<a href="https://commoncog.com/blog/so-good-they-cant-ignore-you/" target="_blank">So Good They Can't Ignore You</a>》），声称乔布斯的这个建议是完全错误的，误导年轻人。别的不说，乔布斯本人也不遵守"热情假设"。年轻时，他对禅宗思想最感兴趣，去印度学习佛教。如果他真的追随自己的内心，他就应该去当一个禅宗老师，而不是跑回美国创办苹果公司。
                </p>
