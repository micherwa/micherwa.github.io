    ...
    <div class="blog-container">
        ...
        <BlogContent :useCatalog="false">
            <div slot="content">
                ...
                <p>
                    除了技术问题之外，面试的最后，我通常都会再问一个问题：<strong>除了上班，你平时的业余时间都会做些什么？大多数候选人会回答一些他们的业余爱好，却很少有人提及自己会搞一些研究，或者技术上的精进。不仅如此，他们往往对于自己的技术水平定位不够清晰</strong>。对于这一类求职者，我只能叹息着说声抱歉。
                </p>

                <p>这让我想起了之前在segmentfault上的一个问答，关于前端求职的困扰。</p>
                ...
                <p>
                    <strong>4.关于vue</strong><br>
                    会vue，并不是敲门砖。
                </p>
                <p>
                    但是，<strong>如果是同一个demo，你能用angular(1/2/4/...)，或者react实现一遍。以此来说说，这3大主流框架在你使用过程中的感受，它们之间的区别是什么，那会是个不错的加分项</strong>。起码给面试官的感觉，你这个人非常的好学，还喜欢钻研。
                </p>

                <p>
                    <strong>5.最后</strong><br>
                    前端的体系庞杂，从培训班出来，只能说明你准备走这条路而已。一切还得从头开始，把心静下来，好好地沉淀。在综合考虑薪资和作息之后（记得多锻炼，未来拼的更多的将会是身体），只要不是太委屈，就先做起来，你的前端经验也能早一天开始累积。
                </p>
                <p>没什么好迷茫的，路就在那里，只是看你想怎么走，走的时候心情如何罢了。</p>
                ...
                <p>
                    其实无论你是培训班出生，还是科班出生，无论你是转行到前端，还是一毕业就做了前端，这些都不是最关键的，最关键的还是<strong>要怀着对前端的热爱，不断学习精进技术</strong>。
                </p>
                <p>
                    有人说，今年这个寒冬，将是未来十年中最温暖的一个冬天，因为未来将会更冷。<strong>为了能在这个寒冷的冬天生存下来，我们每个前端er，乃至每个踏入职场的年轻人，都需要把心静下来，少一份浮躁，多一些沉淀，并且保持长期的耐心，去坚守自己选择的职业道路。</strong>
                </p>
            </div>
        </BlogContent>
    </div>
