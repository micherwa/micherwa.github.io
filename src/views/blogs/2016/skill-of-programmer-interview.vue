        ...
        <BlogContent :useCatalog="true">
            <div slot="content">
                <blockquote>
                    <p>
                        原文来自
                        <a href="http://blog.jobbole.com/99830/" target="_blank">纯干货！程序员面试的技巧</a>。摘录了一些技术之外需要的注意的地方。
                    </p>
                </blockquote>
                ...
                <p>
                    我在面试的时候，有时候会遇到一些候选人，乍一看简历也有好几年工作经验，项目也写的满满的，但是却连“值类型引用类型本质区别”，“构造函数有哪些特点，何时被调用”，“类和接口区别是什么”这样的问题也回答不了，注意，<strong>是回答不了，也就是不知道，不是知道意思但是组织不了语言</strong>。这类候选人通常在连续回答不上几个问题后，开口为自己辩解：“我动手比较强，写代码都没问题，但是书上的概念我真的不太清楚”。能说出这个话，就说明此人根本就明白作为一个技术工作者最基本的专业素质是什么。所以千万不要觉得自己工作几年，有些代码经验就已经可以挑战更加高薪的工作。
                </p>
                ...
                <p>
                    <strong>在面试时，尽量双眼直视面试官（但不要瞪着人家。。。），背挺直，手机开飞行模式，说话口齿清楚，利落干脆，回答得上就尽量说，回答不上直接说不知道，不要罗里吧嗦</strong>，特别是谈到薪酬，对方问你期望时，最好在现有基础上增加10%-20%，不要漫天要价，也不要不好意思，放心大胆的说出你的期望，如果对方觉得略高，会再跟你商量。务必一开口就给人真诚，干练，干脆，专业的印象。
                </p>
                ...
                <p>以上 6 点是自身素质的要求，如果在这6点上面能让面试官满意，基本上面试就没有太大的问题了。接下来换个角度，说说对企业的一些考察</p>
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>无年终奖</li>
                        <li>除了工资以外无任何福利</li>
                        <li>Offer或者合同不量化写清楚工资数字，而是写“和业绩挂钩”，“根据业绩”等</li>
                    </ul>
                </p>

                <h4>5.在面试之前上某勾网，查一下该公司评价</h4>
                <p>
