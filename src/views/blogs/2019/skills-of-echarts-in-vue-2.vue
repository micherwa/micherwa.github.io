<template>
    <div class="blog-container">
        ...
        <BlogContent>
            <div slot="content">
                ...
                <p>标记的用法有很多，今天要介绍的场景有：折线图、柱状图、折线图 + 柱状图。</p>
    ...
    ...
                    ...
                    接下来的这个 <strong>核心</strong> 属性：<code>symbol</code> 是关键，它其实就是折线上的 <code>拐点</code>。
                </p>
...
getSymbolUrl (id) {
    ...
    // 遇到多个 id 的情况，可以多加一个复合图标来处理，id 可以定为 0
                ...
                <p>
                    另外，有的时候，会遇到需要处理柱状图是否堆叠的效果。这会影响 symbolOffset 的定位，为了美观，可以这样处理：对于非堆叠的项，将之往右偏移 50%，将标记居中展示，即 <code>symbolOffset : ['50%', 0]</code>。
                </p>
