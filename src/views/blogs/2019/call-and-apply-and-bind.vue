    ...
    <div class="blog-container">
        ...
        <BlogContent :useCatalog="true">
            <div slot="content">
                ...
                <h4>call 的写法</h4>
                <p>
                    <pre class="hljs fortran"><code style="word-break: break-word; white-space: initial;" class="focus"><span class="hljs-function"><span class="hljs-keyword">Function</span>.<span class="hljs-title">call</span><span class="hljs-params">(obj,[param1[,param2[,…[,paramN]]]])</span></span></code></pre>
                    需要注意以下几点：
                    <ul>
                ...
                <p>
                    <strong>2、借用方法</strong>。还记得刚才的类数组么？如果它想使用 Array 原型链上的方法，可以这样：
                ...
                <h4>apply 的一些妙用</h4>
                <p>
                    <strong>1、Math.max</strong>。用它来获取数组中最大的一项。
                ...
                <p>
                    <strong>2、实现两个数组合并</strong>。在 ES6 的扩展运算符出现之前，我们可以用 Array.prototype.push来实现。
                ...
                <p>
                    它的语法如下：
                    <pre class="hljs fortran"><code style="word-break: break-word; white-space: initial;" class=""><span class="hljs-function"><span class="hljs-keyword">Function</span>.<span class="hljs-title">bind</span><span class="hljs-params">(thisArg[, arg1[, arg2[, ...]]])</span></span></code></pre>
                </p>
                <p>
                    bind 方法 与 apply 和 call 比较类似，也能改变函数体内的 this 指向。不同的是，<strong>bind 方法的返回值是函数，并且需要稍后调用，才会执行</strong>。而 apply 和 call 则是立即调用。
                </p>
                <p>
                    来看下面这个例子：
                    <pre class="hljs perl"><code class="">function <span class="hljs-function"><span class="hljs-keyword">add </span>(<span class="hljs-title">a</span>, <span class="hljs-title">b</span>) </span>{<br>    <span class="hljs-keyword">return</span> a + b;<br>}<br><br>function <span class="hljs-function"><span class="hljs-keyword">sub </span>(<span class="hljs-title">a</span>, <span class="hljs-title">b</span>) </span>{<br>    <span class="hljs-keyword">return</span> a - b;<br>}<br><br>add.bind(<span class="hljs-function"><span class="hljs-keyword">sub</span>, 5, 3)</span>; // <span class="hljs-comment">这时，并不会返回 8</span><br>add.bind(<span class="hljs-function"><span class="hljs-keyword">sub</span>, 5, 3)</span>(); // <span class="hljs-comment">调用后，返回 8</span></code></pre>
                ...
                <img src="~@/assets/blog/bg-20190124-01.jpg">
            </div>
        </BlogContent>
    </div>
</template>
