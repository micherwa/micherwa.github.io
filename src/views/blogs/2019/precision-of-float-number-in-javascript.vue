    ...
    <div class="blog-container">
        ...
        <BlogContent>
            <div slot="content">
                ...
                <p>
                    最近我正好在 gitChat 上看到了，来自百度的大佬 <strong>LucasHC（侯策）</strong> 的系列课程《<strong>前端开发 核心知识进阶</strong>》，因为拜读过大佬写的书 《React 状态管理与同构实战》，所以就买了这门课程。
                </p>
                <p>
                    这门课程共 <strong>50</strong> 讲，从 <strong>36</strong> 个热门主题切入讲解高频面试题，以及会深度剖析底层原理，干货满满，甚至还有不少大佬自己作为 “BAT” 面试官多年的 “私房题”，以及面试时遇到的 “经典题”，非常实用了。
                </p>

                <p>
                    而且刚好现在在搞特价 <strong>69</strong> 元，特价到5月7号结束，没几天了。扫描下图二维码就可以学习，需要的拿走不谢。
