    ...
    <div class="blog-container">
        ...
        <BlogContent>
            <div slot="content">
                ...
                <h2>内推 Tips</h2>
                <p>
                    莉莉丝游戏招 中高级前端工程师 和 广告系统开发工程师（Python 方向）啦！！！
                </p>
                <p>
                    你玩过《<strong>小冰冰传奇</strong>（[刀塔传奇]）》么？你玩过《<strong>剑与家园</strong>》么？你想和 <strong>薛兆丰老师</strong> 成为朋友么？欢迎加入出道即是“巅峰”的莉莉丝游戏哈~
                </p>
                <p>
                    有兴趣的同学，可以关注下面的公众号加我微信详聊哈~
                </p>
            </div>
        </BlogContent>
    </div>
