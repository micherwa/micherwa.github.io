        ...
        <BlogContent :useCatalog="true">
            <div slot="content">
                ...
                <p>
                    ...
                    <pre class="hljs perl"><code class="">console.log(<span class="hljs-number">_</span>.uniq(originalArray));<br><br><span class="hljs-regexp">//</span> [<span class="hljs-number">1</span>, <span class="hljs-string">"1"</span>, <span class="hljs-number">2</span>, true, <span class="hljs-string">"true"</span>, false, null, {…}, {…}, <span class="hljs-string">"abc"</span>, undefined, NaN]</code></pre>
                ...
                <p>
                    ...
                    有比较多的干扰项，那是为了兼容另外两个方法，_.uniqBy 和 _.uniqWith。去除掉之后，就会更容易发现它是用 <code>while</code> 做了循环。当遇到相同的值得时候，<code>continue outer</code> 再次进入循环进行比较，将没有重复的值塞进 <code>result</code> 里，最终输出。
                </p>
