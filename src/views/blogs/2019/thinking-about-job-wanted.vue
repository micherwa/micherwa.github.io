    ...
    <div class="blog-container">
        ...
        <BlogContent>
            <div slot="content">
                ...
                <p>
                    近期的高频面试，以及陆续收到的一些公众号上读者的反馈，让我产生了一些思考。今天，我们不聊具体的技术问题，而是想探讨一些，在面试的过程中需要注意的 <strong>“非技术向的软技能”</strong>，以及一些个人的感悟。
                </p>
                <p>
                    就好比在 “王者荣耀” 中，技能的操作是你的“硬技能”，而局内的出装方案则是“软技能”。优秀的出装方案往往是你登顶之路上的一大助力，希望这些“软技能”对还在求职路上的同学有所帮助，也祝愿所有同学都能迈入心仪的公司，成就“最强王者”！
                </p>
                ...
                <p>
                    我发现很多候选人，不太重视自己过往的项目经验，这让我不能理解。我做过的每一个项目，虽然我在其中可能只负责编写某一个模块，或者功能，但我也会想办法搞清楚整个项目的业务流程，产品设计的意图，我们做的内部功能是如何与外部实现集成的，以及整个系统的架构设计等等。我在面试候选人时，往往会先问最近一个项目的相关内容，有的候选人会说是他自己一个人完成了整个项目的搭建与开发工作，但连其中有哪些模块，为何这样设计，最终如何落地，都答不出来，场面就很尴尬了。
                </p>
                ...
                <h4>5、最后的提问环节</h4>
                <p>
                    面试的最后，都会有提问环节。我发现一个很奇怪的现象，很多同学在往往在这个环节提不出什么问题。面试，是双选选择的一个过程。在自身的技术能力达到对方要求的前提下，当然还得考察这家公司是否适合自己的发展。
                </p>
                <p>
                ...
                <p>如果你觉得希望不大，也可以让面试官给一些建议啊，比如自己有哪些方面比较欠缺，接下来可以如何更进一步地深造。我一直认为，面试除了是检验自身能力的一场试炼之外，还是一次向前辈讨教学习的极佳机会。而且，只有问清楚了上面的这些，你才能在与 HR 聊薪酬与福利待遇的时候，进退有度啊~</p>
                ...
                <p>
                    如果一家公司的卫生间装修得不错，卫生条件也 ok，甚至连厕纸的质量都挺好，那么在其他方面，对待员工应该也差不到哪里去。因为根据我从业这些年的经历来看，我所见过的企业中，几乎都满足这一条。不好的企业，卫生间一定比较破，设施坏了也不会及时修理，可能连厕纸都没有。而好的企业，卫生间装修高档，设施干净，厕纸也比较厚与柔软。如果大家平时留意一下的话，就会发现，一些好的商场，高档的酒店，对于卫生间的装修和干净程度的要求，相对都会比较高。
                </p>
                <p>
                ...
                <p>
                    其实我觉得，是否迎合 996 工作制，完全看自己。如果你觉得太辛苦，完全可以换一个相对轻松一些的工作，996 的工作强度并非有利于每个人的成长速度。而另一方面，正像某位大佬说的，现在的 996 工作制度，在未来的某一天回首时，会发现它是正确的选择，能抗下来的人，都会得到相应的成长。从某方面来说，我是认可这一点的，因为我早在两年前，就开始给自己实行 996 了。利用更多的业余时间，夯实基础，不断学习，并开始陆陆续续地写一些东西。
                </p>

                <p>
                    太过舒适的环境，就像温水煮青蛙，当有一天生存环境崩塌时，再想跳却力不从心了。技术人，应当保持一定的技术敏感度，学习是终生的事情。前端的发展非常迅猛，体系也很庞杂，如果你觉得遇到了瓶颈，那就试着跳出舒适区。不要将自己限制在浏览器端，因为 Node 是一条通往服务端的路，RN 则是另一条通往客户端的路，还要好多的路，就不一一列举了。所以，要有信念，JavaScript 是可以一统天下的（凑不要脸地给自己打气 ^_^）。
                </p>

                <h2>一些干货</h2>
                <p>
                    值得庆幸的是，我警醒得还不晚。所以，在 2018 年底，我开了个人公众号 《超哥前端小栈》，并坚持每周更新一篇，计划先坚持一年。会同步更新到
                    ...
                    上。主要聊聊技术 和 面试，聊聊前端人的成长，不定期还会有内推岗位，希望成为你的陪伴者。
                </p>
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>
                            以及今天的这篇，<strong>面试王者的出装方案推荐——软技能篇</strong>。
                        </li>
                    </ul>
                </p>
